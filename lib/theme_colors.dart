...
const Color kValmetBeige = Color(0xFFFAF3E8);
const Color kValmetButtonGrey = Color(0xFFE0E0E0);
const Color kValmetTextDark = Color(0xFF333333);

// cores para a tela 'Sobre'
const Color kValmetDarkBackground = Color (0xFF767676);
const Color kValmetSubtleDivider = Color (0xFF989898);